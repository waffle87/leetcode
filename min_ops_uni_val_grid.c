...
int main() {
  ...
  int r1 = minOperations(g1->arr, g1->row_size, g1->col_size, 2);
  int r2 = minOperations(g2->arr, g2->row_size, g2->col_size, 1);
  int r3 = minOperations(g3->arr, g3->row_size, g3->col_size, 2);
  printf("%d\n", r1);
  assert(r1 == 4);
  printf("%d\n", r2);
  assert(r2 == 5);
